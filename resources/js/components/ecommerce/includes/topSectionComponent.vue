<template>
    <div>
        ...
        <!-- spinner start -->
        <div class="pre_loading" v-if="loader" style="background: #ffba00;  width: 100%; height: 100%; overflow: hidden; left: 0; ">
                    ...
                    <div class="top_header_menu">
                        <div class="user-menu">
                            <ul>
                                ...
                                <li class="dropdown">
                                    <a><i class="fa fa-user"></i> {{ $t('myAccount') }} <img src="/ecommerce/img/down_arrow.png" alt="" title="" class="down_arrow"></a>
                                    <ul class="dropdown-menu">
