...
<div class="container-fluid">
    ...
    <div class="row clearfix">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <!-- card Start -->
            {!! Form::model($product, ['route' => ['products.update', $product->id], 'files'=> true, 'method' => 'put', 'id' => 'form', 'name' => 'form', 'autocomplete' => 'off']) !!}
            <div class="card">
                <div class="header">
                    <h2>@lang('language.edit') @lang('language.productAlert')
                        <a href="/products" class="btn btn-primary btn_save pull-right">@lang('language.back')</a>
                    </h2>
                </div>
                <div class="body">
                    ...
                    <div class="row clearfix">
                            ...
                            <div class="col-sm-3">
                                <div class="form-group{{ $errors->has('price') ? ' has-error' : '' }}">                                
                                    <div class="form-line">
                                        {!! Form::text('price_0', $product->getChildProduct[0]->price ,['class'=>'form-control', 'placeholder' => __('language.price'), 'min' => 0, 'required' => true]) !!}
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-3">
                                <div class="form-group{{ $errors->has('price') ? ' has-error' : '' }}">
                                    <div class="form-line">
                                        {!! Form::text('sale_price_0', $product->getChildProduct[0]->sale_price ,['class'=>'form-control', 'placeholder' => __('language.salePrice'), 'min' => 0]) !!}
                                    </div>
                                </div>
                            </div>
                ...
                <div class="body">
                    ...
                    <div class="row clearfix">
                        ...
                        <div class="col-sm-2">
                            <div class="form-group{{ $errors->has('key_0') ? ' has-error' : '' }}">
                                <div class="form-line">
                                {!! Form::text('key_arabic_0', isset($product->getProductSpecification[0]) ? $product->getProductSpecification[0]->key_arabic : null,['class'=>'form-control', 'placeholder' => __('language.keyArabic')]) !!}
                                </div>
                                <small class="text-danger">{{ $errors->first('key_arabic_0') }}</small>
                            </div>
                        </div>
                        <div class="col-sm-2">
                        ...
                        <div class="col-sm-2">
                            <div class="form-group{{ $errors->has('value_arabic_0') ? ' has-error' : '' }}">
                                <div class="form-line">
                                {!! Form::text('value_arabic_0', isset($product->getProductSpecification[0]) ? $product->getProductSpecification[0]->value_arabic : null,['class'=>'form-control', 'placeholder' => __('language.valueArabic')]) !!}
                                </div>
                                <small class="text-danger">{{ $errors->first('value_arabic_0') }}</small>
                            </div>
                        </div>
    ...
    if (contChild > 1) {
        ...
        if (contSpec > 1) {
            @foreach($product->getProductSpecification as $keyKV => $valueKV)
                ...
                if (key == y) {
                    $('.input_fields_container_specification').append('<div class="row clearfix"><div class="col-sm-2"><div class="form-group"><div class="form-line"><input class="form-control" placeholder="@lang('language.key')" name="key_'+y+'" value="{{$valueKV->key}}" type="text" ></div><small class="text-danger"></small></div></div><div class="col-sm-2"><div class="form-group"><div class="form-line"><input class="form-control" placeholder="@lang('language.keyArabic')" name="key_arabic_'+y+'" value="{{$valueKV->key_arabic}}" type="text" ></div><small class="text-danger"></small></div></div><div class="col-sm-2"><div class="form-group"><div class="form-line"><input class="form-control" placeholder="@lang('language.value')" name="value_'+y+'" type="text"  value="{{$valueKV->value}}"></div><small class="text-danger"></small></div></div><div class="col-sm-2"><div class="form-group"><div class="form-line"><input class="form-control" placeholder="@lang('language.valueArabic')" name="value_arabic_'+y+'" type="text"  value="{{$valueKV->value_arabic}}"></div><small class="text-danger"></small></div></div><div class="col-sm-2"><div class="form-group"><button type="button" class="btn btn-danger remove_field_spec add_more_button pull-right" id="{{$valueKV->id}}">@lang('language.removeValue')</button></div></div></div>');
                    y++;
                }
            @endforeach
        }
