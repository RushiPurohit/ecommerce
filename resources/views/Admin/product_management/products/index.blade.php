                                ...
                                @foreach($products as $product)
                                    <tr>
                                        ...
                                        <?php if(Auth::user()->role_id != 2){ ?>
                                            <td>
                                                <div class="switch">
                                                    <label><input type="checkbox" onclick="customChangeStatus(this.value, <?php echo $product->id; ?>, 'products' )" value="{{$product->status}}" <?php if ($product->status == '1') {echo 'checked';}?> ><span class="lever" ></span></label>
                                                </div>
                                            </td>
                                        <?php } ?>
