...
<div class="container-fluid">
    ...
    <div class="row clearfix">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <!-- card Start -->
            {!! Form::open(['route' => 'products.store', 'files'=> true, 'id' => 'form', 'name' => 'form', 'autocomplete' => 'off']) !!}
            <div class="card">
                <div class="header">
                    ...
                    <div class="row clearfix">
                            ...
                            <div class="col-sm-3">
                                <div class="form-group{{ $errors->has('price') ? ' has-error' : '' }}">                                
                                    <div class="form-line">
                                        {!! Form::text('price_0', null ,['class'=>'form-control', 'placeholder' => __('language.price'), 'min' => 0, 'required' => true]) !!}
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-3">
                                <div class="form-group{{ $errors->has('price') ? ' has-error' : '' }}">
                                    <div class="form-line">
                                        {!! Form::text('sale_price_0', null ,['class'=>'form-control', 'placeholder' => __('language.salePrice'), 'min' => 0]) !!}
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="body">
                    ...
                    <div class="row clearfix">
                        ...
                        <div class="col-sm-2">
                            <div class="form-group{{ $errors->has('key_0') ? ' has-error' : '' }}">
                                <div class="form-line">
                                {!! Form::text('key_arabic_0', null,['class'=>'form-control', 'placeholder' => __('language.keyArabic')]) !!}
                                </div>
                        ...
                        <div class="col-sm-2">
                            <div class="form-group{{ $errors->has('value_arabic_0') ? ' has-error' : '' }}">
                                <div class="form-line">
                                {!! Form::text('value_arabic_0', null,['class'=>'form-control', 'placeholder' => __('language.valueArabic')]) !!}
                                </div>
