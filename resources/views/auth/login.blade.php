...
<body class="login-page">
    <div class="login-box">
        <div class="logo">
            <a href="javascript:void(0);">@lang('language.login')</a>
            <small></small>
        </div>
        <div class="card">
            <div class="body">
            ...
            @endif
                <form id="sign_in" method="POST" action="{{ route('login') }}">
                    ...
                    <div class="input-group">
                        ...
                        <div class="form-line">
                            <input type="text" class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" name="email" placeholder="@lang('language.email')" required autofocus>
                        </div>
                    </div>
                    <div class="input-group">
                        <span class="input-group-addon">
                        ...
                        <div class="form-line">
                            <input type="password" class="form-control{{ $errors->has('password') ? ' is-invalid' : '' }}" name="password" placeholder="@lang('language.password')" required>
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-4">
                            <button class="btn btn-block bg-pink waves-effect btn_save" type="submit">@lang('language.sign_in')</button>
                        </div>
                    </div>
